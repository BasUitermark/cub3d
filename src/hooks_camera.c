...
/*   Updated: 2023/03/11 14:37:55 by buiterma      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	look_left(t_cub3d *cub3d, t_player *player)
{
	...
	player->direction.x = player->direction.x * cos(-cub3d->rot_speed) - \
						player->direction.y * sin(-cub3d->rot_speed);
	player->direction.y = old_dir_x * sin(-cub3d->rot_speed) + \
						player->direction.y * cos(-cub3d->rot_speed);
	player->plane.x = player->plane.x * cos(-cub3d->rot_speed) - \
					player->plane.y * sin(-cub3d->rot_speed);
	player->plane.y = old_plane * sin(-cub3d->rot_speed) + \
					player->plane.y * cos(-cub3d->rot_speed);
}
...
void	execute_pan(t_cub3d *cub3d, t_player *player)
{
	...
	cub3d->rot_speed = ft_linear_conversion(player->input_range, \
